...
public interface HeosDeviceManager {
	 ...
	 * @param device UPNP device that represents a Heos speaker
	 ...
	 * @param devices UPNP devices which represent Heos speakers
	 * @return Set of Heos speakers
	 * @throws IOException
	 */
	 ...
	 * @param comannd Heos command to be issued. A command must start with the heos:// protocol identifier
	 * @param speaker Heos speaker which should receive the command
